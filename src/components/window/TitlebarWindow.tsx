...
import { TopLevelMenu } from "./menu/TopLevelMenu";
...
export function TitlebarWindow({
  windowId,
  children,
  title,
}: TitlebarWindowProps) {
  ...
  const { setIsDragging, setStartPos, setDragPos } =
  ...
  return (
    <ResizableWindow windowRef={resizableWindowRef} windowId="initial-window">
      <div
        onSelect={() => false}
